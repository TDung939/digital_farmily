...
const objects = [
  ...
  { el: document.getElementById('bong'), lastX: 940, targetX: 0, speed: 3},
  { el: document.getElementById('hai'), lastX: 640, targetX: 0, speed: 2},
  { el: document.getElementById('bep'), lastX: 230, targetX: 0, speed: 2},
  { el: document.getElementById('nhi'), lastX: 50, targetX: 0, speed: 1}
];
